...
CREATE TABLE `Users` (
  ...
  `usersPassword` varchar(512) NOT NULL,
...
CREATE TABLE `UsersBackup` (
  ...
  `usersbackupPassword` varchar(512) DEFAULT NULL,
...
BEGIN
    ...
    DELETE FROM Users WHERE usersUsername = valueUsername OR usersEmail = valueEmail AND encryptPassword = storedPassword LIMIT 1;
...
BEGIN
    ...
    WHERE usersUsername = valueUsername OR
...
BEGIN
    ...
    WHERE usersUsername = storedUsername OR
...
-- Dump completed on 2024-07-17 16:09:11
